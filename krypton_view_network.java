...
//load images from JAR
	...
	for(int xloop2 = 0; xloop2 < network.network[0].length; xloop2++){//*********************

	ip_log_book[0][xloop2] = new JLabel(network.network[0][xloop2], JLabel.LEFT);
	ip_log_book[1][xloop2] = new JLabel(network.network[1][xloop2], JLabel.LEFT);
	ip_log_book[2][xloop2] = new JLabel(network.network[2][xloop2], JLabel.LEFT);
	...
	ip_log_book[0][xloop2].setText(network.network[0][xloop2]);
	ip_log_book[1][xloop2].setText(network.network[1][xloop2]);
	ip_log_book[2][xloop2].setText(network.network[2][xloop2]);
