...
public class ltc_miner implements Observer {
	...
	public void update(Observable o, Object arg) {
		...
		if (n == ltc_worker.Notification.SYSTEM_ERROR) {
			...
			//krypton.ltc_mining_speed = "Error";
			krypton.status_x3.setIcon(krypton.imx0);
			...
			if (lastWorkTime > 0L) {
				...
				//krypton.ltc_mining_speed = String.format("%.2f khash/s", speed);
				krypton.status_x3.setIcon(krypton.imx1);
			}//*********************
			else{krypton.status_x3.setIcon(krypton.imx0);}
